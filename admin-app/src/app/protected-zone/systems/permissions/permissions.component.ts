...
export class PermissionsComponent implements OnInit {
  ...
  public savePermission() {
    ...
    this.permissionsService.save(this.selectedRole.id, permissionsUpdateRequest)
      .subscribe(() => {
  ...
  loadData(roleId) {
    if (roleId != null) {
      this.blockedPanel = true;
      this.permissionsService.getFunctionWithCommands()
        .subscribe((response: any) => {
  ...
  fillPermissions(roleId: any) {
    this.blockedPanel = true;
    this.rolesService.getRolePermissions(roleId)
